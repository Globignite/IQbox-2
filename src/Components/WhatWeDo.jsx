...
<section className="who-we-are-section overflow-hidden our-servicess">
  <div className="section-2">
    <figure className="who-we-right-fig">
      <img src="./assets/images/section2-before-img.png" alt className="star" />
    </figure>
    <div className="container">
      <div className="row">
        ...
        <div className="col-xl-7 col-lg-6 col-md-12 col-sm-12">
          <div className="about-us-content aos-init aos-animate mr-0" data-aos="fade-up">
            <h6 className="autorix-text">What we do</h6>
            <h2 data-aos="fade-zoom-in" className="aos-init aos-animate section2-h2">
